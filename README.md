...
*Note: these numbers were measured with Claude as the judge/consistency-checker model (the setup used at evaluation time). The app has since switched to Qwen3.8-27B via Groq in that role; results have not yet been re-measured against the new configuration.*
